...
public partial class GenreResults
{
    [Parameter]
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        medias = medias.Where(m => m.Genre.GenreName.ToLower() == GenreName.ToLower() && (m.Title.Contains(SearchText, StringComparison.InvariantCultureIgnoreCase) || m.Description.Contains(SearchText, StringComparison.InvariantCultureIgnoreCase))).ToList();
    }
